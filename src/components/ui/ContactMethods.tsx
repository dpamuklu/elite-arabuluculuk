  ...
  ({ icon, title, value, href, description, className }, ref) => (
    <div ref={ref} className={cn("flex items-start space-x-4", className)}>
      ...
      <div className="flex-1 min-w-0">
        <h3 className="text-lg font-semibold text-navy-900 turkish-text">
          {title}
        </h3>
        {href ? (
          <a
        ...
        {description && (
          <p className="text-sm text-navy-600 mt-1 turkish-text">
            {description}
          </p>
        )}
      </div>
...
const ContactMethodsGrid = React.forwardRef<
  HTMLDivElement,
...
>(({ className }, ref) => (
  ...
  >
    ...
    <ContactMethod
      ...
      title="E-posta"
      value="info@elitearabuluculuk.com"
    ...
    <ContactMethod
      ...
      title="SSS"
      value="Sıkça Sorulan Sorular"
      href="/sikca-sorulan-sorular"
      description="Arabuluculuk süreci hakkında yanıtları keşfedin"
    />
  </div>
));
...
const QuickContactCard = React.forwardRef<
  HTMLDivElement,
...
>(({ className }, ref) => (
  ...
  >
    <CardHeader>
      ...
      <p className="text-white/90 turkish-text">
    ...
    <CardContent className="space-y-4">
      ...
      <div className="pt-4 border-t border-primary-500">
        <p className="text-sm text-white/90 turkish-text">
          ...
          <div key={index} className="flex items-center space-x-3">
            ...
            <div>
              ...
              {method.href ? (
                ...
                <span className="ml-2 text-navy-900 turkish-text">
                  {method.value}
                </span>
              )}
            </div>
...
const EmergencyContact = React.forwardRef<
  HTMLDivElement,
  EmergencyContactProps
>(({ className }, ref) => (
  <div
    ref={ref}
    className={cn("bg-red-50 border border-red-200 rounded-lg p-6", className)}
  >

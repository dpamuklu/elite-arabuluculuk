...
export const metadata: Metadata = {
  ...
  description:
    "Ticari, kira, iş hukuku ve tüketici arabuluculuğu hizmetlerimiz. Uzman arabulucularımızla uyuşmazlıklarınızı hızla çözün.",
  keywords: [
    "arabuluculuk hizmetleri",
    "ticari arabuluculuk",
    "kira arabuluculuğu",
    "iş hukuku arabuluculuğu",
    "tüketici arabuluculuğu",
  ],
  openGraph: {
    title: "Arabuluculuk Hizmetlerimiz | Elite Arabuluculuk",
    description:
      "Profesyonel arabuluculuk hizmetlerimiz ile uyuşmazlıklarınızı adil ve hızlı şekilde çözün.",
  },
};
...
export default function HizmetlerPage() {
  ...
  const serviceCategories: ServiceCategory[] = [
    ...
    },
    {
      ...
      description:
        "Kiracı–ev sahibi arasında kira tespiti, tahliye ve alacak uyuşmazlıklarının çözümlenmesi",
      icon: "users",
      features: [
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <TypographyP className="text-lg max-w-2xl mx-auto">
              Her alanda uzmanlaşmış arabulucularımızla size en uygun çözümü
              sunuyoruz.
            </TypographyP>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            {serviceCategories.map((service) => (
              <div
                key={service.id}
                className="bg-white rounded-xl border border-border p-8 card-shadow"
              >
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="font-semibold text-navy-900 mb-3 turkish-text">
                      Çözüm Alanları:
                    </h4>
          ...
          <div className="bg-gradient-to-r from-primary-600 to-primary-800 rounded-2xl p-8 lg:p-12 text-white text-center">
            ...
            <TypographyP className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              Uzman arabulucularımız size en uygun çözümü bulmak için ücretsiz
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <TypographyP className="text-lg max-w-3xl mx-auto">
              10 yılı aşkın deneyimimiz ve 2k+ başarılı vakamızla size en
              kaliteli arabuluculuk hizmetini sunuyoruz.
            </TypographyP>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <TypographyP>
                Her alanda uzmanlaşmış, sertifikalı ve sicile kayıtlı
                arabulucularımız ile çalışıyoruz.
              </TypographyP>
            </div>
            ...
            <div className="text-center">
              ...
              <TypographyP>
                Tüm süreçlerimizde tam gizlilik ve tarafsızlık ilkelerine bağlı
                kalıyoruz.
              </TypographyP>
            </div>
          </div>

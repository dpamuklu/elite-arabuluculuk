      ...
      <section className="section-padding bg-white">
        <div className="container max-w-3xl">
          ...
          <TypographyP className="mb-4">
            Sitedeki bilgiler genel niteliktedir; hukuki danışmanlık yerine
            geçmez. Hizmetler, randevu ve yazılı onay akışına tabidir.
          </TypographyP>

          <TypographyH2 className="mb-3">Sorumluluk Reddi</TypographyH2>
          <TypographyP className="mb-4">
            İçeriklerin doğruluğu için özen gösterilse de hatalar olabilir. Site
            kullanımından doğan dolaylı zararlardan sorumluluk kabul edilmez.
          </TypographyP>

          <TypographyH2 className="mb-3">Fikri Mülkiyet</TypographyH2>
          <TypographyP className="mb-4">
            Metin, görsel ve logolar dâhil tüm içerikler telif hakkına tabidir.
            Yazılı izin olmadan kopyalanamaz veya çoğaltılamaz.
          </TypographyP>
        </div>
      </section>
    </div>
